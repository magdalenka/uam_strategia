...
insert into strategia(id_parent, lp, nazwa_strategii, nazwa_jednostki, widocznosc, organization_key)
values (1, 2, 'Strategia Rozwoju Wydzia³u Chemii Uniwersytetu Im. Adama Mickiewicza w Poznaniu', 'Wydzia³ Chemii Uniwersytetu im. Adama Mickiewicza', 1, '0300000000')

insert into strategia(id_parent, lp, nazwa_strategii, nazwa_jednostki, widocznosc, organization_key)
values (1, 2, 'Misja Wydzia³u Neofilologii UAM w Poznaniu', 'Wydzia³ Neofilologii Uniwersytetu im. Adama Mickiewicza', 1, '1100000000')

-- cele strategiczne chemii
insert into cel (lp, id_strategii, id_parent, tresc)
values (1, 2, null, 'BADANIA NAUKOWE na œwiatowym poziomie')
insert into cel (lp, id_strategii, id_parent, tresc)
values (2, 2, null, 'Najwy¿sza jakoœæ KSZTA£CENIA')
insert into cel (lp, id_strategii, id_parent, tresc)
values (3, 2, null, 'Wydzia³ OTWARTY na otoczenie')
insert into cel (lp, id_strategii, id_parent, tresc)
values (4, 2, null, 'Wydzia³ profesjonalnie ZARZ¥DZANY')

--cele operacyjne
insert into cel (lp, id_strategii, id_parent, tresc)
values (1, 2, 96, 'Wspieranie rozwoju naukowego pracowników')
insert into cel (lp, id_strategii, id_parent, tresc)
values (2, 2, 96, 'Poszerzanie interdyscyplinarnoœci badañ naukowych')
insert into cel (lp, id_strategii, id_parent, tresc)
values (3, 2, 96, 'Umiêdzynarodowienie badañ')
insert into cel (lp, id_strategii, id_parent, tresc)
values (4, 2, 96, 'Wzmacnianie infrastrutury badawczej')
insert into cel (lp, id_strategii, id_parent, tresc)
values (5, 2, 96, 'Wdro¿enie systemu ochrony i korzystania z w³asnoœci intelektualnej')

insert into cel (lp, id_strategii, id_parent, tresc)
values (1, 2, 97, 'Rozwój w ewnêtrznego systemu oceny i zapewnienia jakoœci kszta³cenia')
insert into cel (lp, id_strategii, id_parent, tresc)
values (2, 2, 97, 'Uporz¹dkowanie zasad organizacyjnych i programowych na trzech poziomach studiów')
insert into cel (lp, id_strategii, id_parent, tresc)
values (3, 2, 97, 'Zró¿nicowanie oraz zwiêkszenie oferty i trybów studiów')
insert into cel (lp, id_strategii, id_parent, tresc)
values (4, 2, 97, 'Kszta³towanie kompetencji absolwenta')
insert into cel (lp, id_strategii, id_parent, tresc)
values (5, 2, 97, 'Wspieranie samodzielnoœci studentów I i II stopnia')
insert into cel (lp, id_strategii, id_parent, tresc)
values (6, 2, 97, 'Internacjonalizacja kszta³cenia')
insert into cel (lp, id_strategii, id_parent, tresc)
values (7, 2, 97, 'Rozbudowa nowoczesnej infrastruktury kszta³cenia')

insert into cel (lp, id_strategii, id_parent, tresc)
values (1, 2, 98, 'Wzrost znaczenia kulturoznawczej roli uczelni w regionie')
insert into cel (lp, id_strategii, id_parent, tresc)
values (2, 2, 98, 'Otwarcie na potrzeby i aspiracje edukacyjne spo³ecznoœci miasta i regionu')
insert into cel (lp, id_strategii, id_parent, tresc)
values (3, 2, 98, 'Otwarcie uniwersytetu na potrzeby gospodarki opartej na wiedzy')
insert into cel (lp, id_strategii, id_parent, tresc)
values (4, 2, 98, 'Wzmacnianie wiêzi z absolwentami uczelni')
insert into cel (lp, id_strategii, id_parent, tresc)
values (5, 2, 98, 'Intensyfikacja wspó³pracy z w³adzami miasta i regionu')

insert into cel (lp, id_strategii, id_parent, tresc)
values (1, 2, 99, 'Wprowadzanie strategicznego zarz¹dzania Wydzia³em Chemii')
insert into cel (lp, id_strategii, id_parent, tresc)
values (2, 2, 99, 'Udoskonalenie kultury organizacyjnej')
insert into cel (lp, id_strategii, id_parent, tresc)
values (3, 2, 99, 'Zwiêkszenie efektywnoœci organizacji pracy administracji wydzia³owej i innych jednostej organizacyjnych')
insert into cel (lp, id_strategii, id_parent, tresc)
values (4, 2, 99, 'Przekszta³cenie procesu administrowania w proces zarz¹dzania kadrami')
insert into cel (lp, id_strategii, id_parent, tresc)
values (5, 2, 99, 'Doskonalenie systemu zarz¹dzania finansami')
insert into cel (lp, id_strategii, id_parent, tresc)
values (6, 2, 99, 'Rozwój infrastruktury Wydzia³u Chemii dla zapewnienia najwy¿szej efektywnoœci badañ i kszta³cenia')

-- neofilologia cele strategiczne
insert into cel (lp, id_strategii, id_parent, tresc)
values (1, 3, null, 'Badania naukowe na œwiatowym poziomie')
insert into cel (lp, id_strategii, id_parent, tresc)
values (2, 3, null, 'Najwy¿sza jakoœæ kszta³cenia')
insert into cel (lp, id_strategii, id_parent, tresc)
values (3, 3, null, 'Uniwersytet otwarty na otoczenie')
insert into cel (lp, id_strategii, id_parent, tresc)
values (4, 3, null, 'Uczelnia profesjonalnie zarz¹dzania')
